...
const releaseHighlights = [
  {
    label: '创作',
    title: '一句需求，先变成可编辑文稿',
    desc: '自由创作默认开放，也可从讲课、汇报、试卷、讲义和会议纪要等模板快速开始。',
  },
  {
    label: '排版',
    title: '标题、表格、插图和图示都能再调整',
    desc: '辅助代写只负责生成结构化草稿，内容、顺序、图片位置和分页仍由你核对和修改。',
  },
  {
    label: '导出',
    title: 'Word、PPT、PDF 和长图共用一份内容',
    desc: '成品带知潮来源标识，可保存到朵朵笔记附件或交给系统分享；辅助代写不可用时仍可手动排版导出。',
  },
]
