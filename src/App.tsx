...
const faq = [
  ...
  },
  {
    ...
    a: '朵朵是自动回应程序，不是真人，也不能替代医生或心理咨询师。如果你正处在情绪困境中，请联系全国统一心理援助热线 12356；紧急情况请拨打 110 或 120。',
  },
  {
    q: '怎样查看智能服务来源？',
    a: '生成内容会在对应页面标明来源。当前接入 DeepSeek-V4 系列；服务来源备案信息为 Deepseek Chat（Beijing-DeepseekChat-202404280016）和深度求索大模型算法（网信算备110108970550101240011号）。完整的数据处理与标识说明可在 App 设置和隐私政策中查看。',
  },
  {
    q: '现在还支持用户上传题库吗？',
