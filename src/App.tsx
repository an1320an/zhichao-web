...
const faq = [
  ...
  },
  {
    ...
    a: '密码采用 bcrypt 单向哈希保存，我们无法还原或查看你的明文密码。账本、学习和聊天属于账号私有业务数据，不会公开展示，也不用于广告；它们不是“连服务器也无法解密”的端到端加密数据。只有在安全排障、履行法律义务或处理你的请求确有必要时，受权限控制的人员才可按职责处理必要数据。你可以随时导出数据或注销清理。',
  },
  {
    q: '学习范围需要每次重新设置吗？',
