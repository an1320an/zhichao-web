...
const releaseHighlights = [
  {
    label: '纸面',
    title: '书架、PDF 和手写回到同一套笔记体验',
    desc: '从书架导入 PDF 后即可阅读和批注，文字笔记、画笔、荧光笔、橡皮与套索都在需要时直达。',
  },
  {
    label: '安全',
    title: '旧笔记先备份，再变成只读资料库',
    desc: '旧笔记不再继续写入，仍可从独立入口查看和导出；文字内容尽力导入，失败不会覆盖旧资料。',
  },
  {
    label: '连贯',
    title: '学习内容继续直接收进朵朵笔记',
    desc: '收藏、临床文书、图示、Markdown、截图文字与知识卡片继续沿用同一条保存和复习链路。',
  },
]
...
const changelog = [
  {
    date: '2026-08-10',
    title: '知潮 3.0.69：计划提醒改由系统闹钟或日历承接',
    desc: '用户计划不再使用知潮自有强响铃：临近的一次性计划以及每天、每周重复计划可打开手机系统闹钟确认页，较远日期和每月、每年事项可交给系统日历；仅打开系统页面时，知潮会提示继续确认，不会把它表述为已经同步。系统应用不可用时仍可保留计划并使用普通通知，专注陪学结束也只使用普通通知。已交给系统的闹钟或日程，第一阶段请在对应系统应用中修改或删除。同步优化足迹个人页布局、置顶与按日分组，并修复部分足迹图片不显示的问题。',
  },
  {
    date: '2026-08-10',
