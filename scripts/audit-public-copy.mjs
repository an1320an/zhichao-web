...
const checks = [
  ...
  ["下载确认页保留版本、大小、本次更新与备案", ["3.0.62", "211.3 MB", "本次更新", "图示生成更稳定", "聊天记账更清晰", "导览文字竖排", "陕ICP备2026019822号", "陕公网安备61092802000137号"].every((phrase) => sources["public/download/index.html"].includes(phrase))],
