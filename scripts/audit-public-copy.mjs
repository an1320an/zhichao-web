...
const checks = [
  ...
  ["3.0.75 首页发布身份与功能说明一致", ["const APP_VERSION = '3.0.75'", "知潮 3.0.75 正式更新", "专属学习计划", "不超过五步", "阶段路线", "当前站点", "目标日期", "不承诺考试结果", "服务器维护", "登录前后", "预计恢复时间", "普通断网不会被误报成维护", "给你的一封信", "私密记录"].every((phrase) => sources["src/App.tsx"].includes(phrase))],
  ...
  ["下载确认页保留 3.0.75 正式包身份、非强制更新与备案", ["3.0.75", "versionCode 112", "233515103", "DD247047AA77EDDDB725467D5A233EECCD388F1B2B4A973FDC4178FE88ADED6F", "222.7 MB", "官方已核验", "签名与公网文件一致", "非强制更新", "最新更新：", "2026 年 8 月 12 日 01:05（北京时间）", "专属学习计划", "阶段路线", "当前站点", "今日行动", "服务器维护", "登录", "注册", "预计恢复时间", "普通断网不会被误报成维护", "更新说明改短", "给你的一封信", "账号数据", "金币奖励", "安全规则", "访问知潮官网", "陕ICP备2026019822号", "陕公网安备61092802000137号"].every((phrase) => sources["public/download/index.html"].includes(phrase))],
  ["3.0.75 正式包占位已清除", !["PENDING_3_0_75_APK_SIZE_BYTES", "PENDING_3_0_75_APK_SHA256", "待正式包核验"].some((phrase) => sources["public/download/index.html"].includes(phrase))],
  ["3.0.75 发布时间占位已清除", !["正式发布后更新", "精确时刻待正式切换", "公网文件待发布后复核"].some((phrase) => publicCopy.includes(phrase))],
