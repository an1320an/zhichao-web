...
const checks = [
  ...
  ["下载确认页保留版本、大小、本次更新与备案", ["3.0.64", "211.5 MB", "本次更新", "文档工坊", "Word、PPT、PDF 和长图", "辅助代写不可用时", "陕ICP备2026019822号", "陕公网安备61092802000137号"].every((phrase) => sources["public/download/index.html"].includes(phrase))],
