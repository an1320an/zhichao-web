...
const checks = [
  ...
  ["3.0.73 更新日志已准备", ["知潮 3.0.73：首页、刷卡、主题与足迹体验升级", "问朵朵·找功能", "中文释义", "普通主题", "1000 金币", "六套限定主题", "成就解锁", "九图长按排序", "当天上下文详情", "四种时光回看场景", "AI 日签", "朵朵百态·初遇篇", "20 张免费心情彩蛋", "彩蛋册", "文字创意参与共创", "账单朵朵短评", "MDT", "黄赌毒政", "提示注入保护", "AI 智能服务统一使用一次简洁授权", "规则兜底", "安全筛查和去标识", "版本化更新并可回滚", "记账短评仅作人工审核参考", "不会自动训练第三方模型", "访问知潮官网"].every((phrase) => sources["src/App.tsx"].includes(phrase))],
  ...
  ["3.0.74 首页发布身份与既有功能说明一致", ["const APP_VERSION = '3.0.74'", "知潮 3.0.74 正式更新", "首页找功能", "中文释义", "普通主题", "1000 金币", "六套限定主题", "长按排序", "当天记录", "四种时光回看场景", "AI 日签", "朵朵百态·初遇篇", "20 张", "账单短评完整展示", "MDT", "统一授权", "安全筛查和去标识", "不会自动训练第三方模型"].every((phrase) => sources["src/App.tsx"].includes(phrase))],
  ...
  ["下载确认页保留 3.0.74 精确包身份、非强制更新与备案", ["3.0.74", "versionCode 111", "231023924", "37DAD7F6D1E7CEFCC6642D7270F7BE60B04945861F501AB117695AA1ACC8313F", "220.3 MB", "非强制更新", "最新更新：", "（北京时间）", "首页找功能", "刷卡提示", "全局主题", "九图足迹", "时光回看", "朵朵彩蛋", "账号数据", "金币奖励", "安全规则", "提示注入保护", "离线兜底", "访问知潮官网", "陕ICP备2026019822号", "陕公网安备61092802000137号"].every((phrase) => sources["public/download/index.html"].includes(phrase))],
