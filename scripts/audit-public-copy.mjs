...
const checks = [
  ...
  ["下载确认页保留版本、大小、本次更新与备案", ["3.0.63", "211.4 MB", "本次更新", "计划提醒和专注结束", "聊天内容新增表格", "旧笔记恢复", "陕ICP备2026019822号", "陕公网安备61092802000137号"].every((phrase) => sources["public/download/index.html"].includes(phrase))],
