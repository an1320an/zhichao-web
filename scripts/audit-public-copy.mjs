...
const checks = [
  ...
  ["下载确认页保留 3.0.75 发布准备身份、非强制更新与备案", ["3.0.75", "versionCode 112", "PENDING_3_0_75_APK_SIZE_BYTES", "PENDING_3_0_75_APK_SHA256", "待正式包核验", "待正式发布", "非强制更新", "最新更新：", "专属学习计划", "阶段路线", "当前站点", "今日行动", "服务器维护", "登录", "注册", "预计恢复时间", "普通断网不会被误报成维护", "更新说明改短", "给你的一封信", "账号数据", "金币奖励", "安全规则", "访问知潮官网", "陕ICP备2026019822号", "陕公网安备61092802000137号"].every((phrase) => sources["public/download/index.html"].includes(phrase))],
