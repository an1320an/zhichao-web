...
const checks = [
  ...
  ["更新日志固定显示 3.0.78/3.0.77/3.0.76 且无失效历史入口", sources["src/App.tsx"].includes("changelog.slice(0, 3)") && sources["src/App.tsx"].includes("官网固定展示最近三次正式更新") && sources["public/download/index.html"].includes('<meta name="zhichao-recent-releases" content="3.0.78,3.0.77,3.0.76" />') && ["知潮 3.0.78：", "知潮 3.0.77：", "知潮 3.0.76："].every((title, index, titles) => index === 0 || sources["src/App.tsx"].indexOf(titles[index - 1], sources["src/App.tsx"].indexOf("const changelog =")) < sources["src/App.tsx"].indexOf(title, sources["src/App.tsx"].indexOf("const changelog ="))) && sources["src/App.tsx"].includes("useHashNavigation()") && sources["src/App.tsx"].includes("scrollIntoView") && !sources["src/App.tsx"].includes("showAllChangelog") && !sources["src/App.tsx"].includes("查看更多更新")],
  ...
  ["3.0.78 首页发布身份与功能说明一致", ["const APP_VERSION = '3.0.78'", "知潮 3.0.78 正式更新", "多主题", "五运六气", "潮汐来信", "系统分享", "聊天表格"].every((phrase) => sources["src/App.tsx"].includes(phrase))],
  ...
  ["下载确认页保留 3.0.78 正式包身份、非强制更新与备案", ["3.0.78", "versionCode 115", "233755940", "B3410C0F84B2FF4892CCFEB98ADD61729F81F4FC7F07532A9D423FF3CF35D77E", "222.9 MB", "官方已核验", "签名与公网文件一致", "非强制更新", "最新更新：", "2026 年 8 月 12 日 22:18（北京时间）", "五运六气", "每周最多三封", "鲸歌保持更稀有", "系统面板", "管理员公告", "访问知潮官网", "陕ICP备2026019822号", "陕公网安备61092802000137号"].every((phrase) => sources["public/download/index.html"].includes(phrase))],
