...
const checks = [
  ...
  ["下载确认页保留 3.0.73 精确包身份、非强制更新与备案", ["3.0.73", "versionCode 110", "231023547", "33F1EDD46DD3642766BBF9A7F37B4936E00C7E36DAEE70CA11256A13134F9785", "220.3 MB", "非强制更新", "最新更新：", "（北京时间）", "首页找功能", "中文释义", "普通主题", "1000 金币", "六套限定主题", "成就解锁", "长按排序", "当天上下文", "四种时光回看场景", "AI 日签", "朵朵百态·初遇篇", "20 张免费彩蛋", "文字创意共创", "账单朵朵短评完整显示", "MDT", "提示注入保护", "统一授权", "离线或服务失败", "不会自动训练第三方模型", "访问知潮官网", "陕ICP备2026019822号", "陕公网安备61092802000137号"].every((phrase) => sources["public/download/index.html"].includes(phrase))],
